...
//  DistillIdeas
//
//  StoreKit 2 implementation for Distill premium subscriptions
//
...
enum StoreKitProductID: String, CaseIterable {
    case weekly = "com.appfactory.distillideas.subscription.weekly"
    case monthly = "com.appfactory.distillideas.subscription.monthly"
    case yearly = "com.appfactory.distillideas.subscription.yearly"
    case lifetime = "com.appfactory.distillideas.lifetime"
...
final class StoreKitManager {
    ...
    var yearlyProduct: Product? {
        allProducts.first { $0.id == StoreKitProductID.yearly.rawValue }
    }

    var monthlyProduct: Product? {
        allProducts.first { $0.id == StoreKitProductID.monthly.rawValue }
    }

    var weeklyProduct: Product? {
        allProducts.first { $0.id == StoreKitProductID.weekly.rawValue }
    }

    var lifetimeProduct: Product? {
        allProducts.first { $0.id == StoreKitProductID.lifetime.rawValue }
    }
...
extension Product {
    ...
    var savingsLabel: String? {
        ...
        case .year: return "Save 60% · Best Value"
        default: return nil
        }
    }
